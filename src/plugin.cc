...
zeek::plugin::Configuration Plugin::Configure() {
    AddComponent(new zeek::iosource::PktSrcComponent("UDP", "udp", zeek::iosource::PktSrcComponent::LIVE,
                                                     zeek::packetsource::udp::UDPSource::Instantiate));

    // Install custom ConnKey implementations.
    AddComponent(new zeek::conn_key::Component("PACKETSOURCE_UDP_VXLAN_VNI_FIVETUPLE",
                                               zeek::packetsource::udp::conn_key::VxlanVniFactory::Instantiate));

    AddComponent(new zeek::conn_key::Component("PACKETSOURCE_UDP_GENEVE_VNI_FIVETUPLE",
                                               zeek::packetsource::udp::conn_key::GeneveVniFactory::Instantiate));

    AddComponent(new zeek::conn_key::Component("PACKETSOURCE_UDP_GENEVE_VXLAN_VNI_FIVETUPLE",
