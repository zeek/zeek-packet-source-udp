# Do not change this file if at all possible. If anything, use the most recent
# one from the zeek/package-template repo. Thanks!
execute_process(
...
if(NOT zeek_config_result EQUAL 0)
  message(
    FATAL_ERROR "zeek-config failed: ${zeek_config_error} ${zeek_config_result}"
  )
endif()
